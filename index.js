let gameOver = false;
let score = 0;
let board = []; // Variável board movida para fora da função startGame
let bgm = new Audio(); // Criando um elemento de áudio e atribuindo-o à variável bgm
...
function startGame() {
  ...
  if (!gameOver) {
    ...
    // retorna um tetromino aleatório com uma posição inicial aleatória na parte superior do tabuleiro.
    ...
    //   // Lógica para mover o tetromino fantasma
    // }

 
    //  Inicialização do tetromino atual e fantasma
    let currentTetromino = randomTetromino();
    let currentGhostTetromino; //será usado para mostrar a posição onde o tetromino atual irá cair.
 
    // Desenho do tetromino atual
    ...
    // remoção do tetromino do tabuleiro
    function eraseTetromino() {
      //remove visualmente o tetromino atual do tabuleiro.
    ...
    window.rotateTetromino = function () {
      rotatedShape = [];
    ...
    // Move the tetromino
    window.moveTetromino = function(direction) {
    ...
    function handleKeyPress(event) {
      switch (event.keyCode) {
        case 37: // left arrow
        window.moveTetromino("left");
          break;
        case 39: // right arrow
        window.moveTetromino("right");
          break;
        case 40: // down arrow
        window.moveTetromino("down");
          break;
        case 38: // up arrow
        window.rotateTetromino();
          break;
        case 32: // up arrow
        window.drop();
          break;
    ...
    // COMEÇANDO A MODIFICAR DESDE AQUI
    inicioScore(); }
  //  else {
  //   document.getElementById("score").textContent =
  //     "Parabéns! Sua pontuação foi" +
  //     score +
  //     " pontos, para jogar novamente click JOGAR NOVAMENTE!. ";
  // }
}
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  playAgainBtn.addEventListener('click', function() {
      location.reload(); // Recarregar a página para jogar novamente
  });
