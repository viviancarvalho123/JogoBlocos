...
let currentTetromino = randomTetromino();  //é definido como um tetromino aleatório.
let currentGhostTetromino; //será usado para mostrar a posição onde o tetromino atual irá cair.

// Desenho do tetromino atual
function drawTetromino() { //cria elementos HTML para representar visualmente o tetromino atual no tabuleiro.
...
function eraseTetromino() { //remove visualmente o tetromino atual do tabuleiro.
